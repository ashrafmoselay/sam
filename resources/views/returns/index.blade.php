    ...
    <div class="row">
        ...
        <div class="col-md-12">
       		<div class="form-group pull-left">
			    <a class="btn btn-success" href="returns/create" role="button">{{ trans('app.Create') }}</a>
			</div>
...
<script type="text/javascript">
	...
	function appendParm(){
		var from = $(".fromdate").val();
		var to = $(".todate").val();
		var newhref = "{{url('printPdf','returns.')}}"+"?supplier_id="+$(".supplier_id").val()+"&from="+from+"&to="+to;
